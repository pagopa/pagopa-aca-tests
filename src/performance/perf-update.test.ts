...
export let options = {
    ...
    thresholds: {
        ...
        "http_req_duration{name:post-create-position-test-update-flow}": ["p(95)<1000"]
    },
};
...
export default function () {
    ...
    let responseUpdate = http.post(urlBasePath, JSON.stringify(createRequestBodyForAca(100)), {
      ...headersParams,
