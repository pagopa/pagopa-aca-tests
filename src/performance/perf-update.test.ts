...
export default function () {
    ...
    // Update existing debt position
    createPositionBody.amount = createPositionBody.amount + 100;

    let responseUpdate = http.post(urlBasePath, JSON.stringify(createPositionBody), {
      ...headersParams,
